    ...
    <body>
        ...
        <section class="filters">
          <div class="card last-card">
            <div class="filters-bar">
              <a href="index.php?filter=all"><span class="<?=$_GET['filter'] == 'all' || $filter == 'none' ? 'selected' : ''?>">All</span></a>
              <a href="index.php?filter=active"><span class="<?=$_GET['filter'] == 'active' ? 'selected' : ''?>">Active</span></a>
              <a href="index.php?filter=completed"><span class="<?=$_GET['filter'] == 'completed' ? 'selected' : ''?>">Completed</span></a>
            </div>
          </div>
        </section>
      ...
      <footer class="footer">
        <div class="attribution">
          ...
          Coded by <a href="https://github.com/OctavioCaba" target="_blank">Octavio Caba</a>.
        </div>
      </footer>
